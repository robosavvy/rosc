...
find_package(genc)
set(GENC_BIN ${genc_DIR}/../gen_c.py)
set(GENC_TEMPLATE_DIR ${genc_DIR}/../)
...
macro(_generate_msg_c ARG_PKG ARG_MSG ARG_IFLAGS ARG_MSG_DEPS ARG_GEN_OUTPUT_DIR)
  ...
  add_custom_command(OUTPUT ${GEN_OUTPUT_FILE}
    DEPENDS ${GENC_BIN} ${ARG_MSG} ${ARG_MSG_DEPS}
...
macro(_generate_srv_c ARG_PKG ARG_SRV ARG_IFLAGS ARG_MSG_DEPS ARG_GEN_OUTPUT_DIR)
  _generate_msg_c(${ARG_PKG} ${ARG_SRV} "${ARG_IFLAGS}" "${ARG_MSG_DEPS}" ${ARG_GEN_OUTPUT_DIR})
endmacro()
