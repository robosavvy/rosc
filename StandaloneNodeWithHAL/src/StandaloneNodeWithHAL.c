...
int main(void)
{
	...
	unsigned int msglen=generateXML(buf_xml, xml_gen_array, custom_xml_str);
	...
	http_head_gen_command http_gen_array[]=
	{
			...
			HTTP_HEADER_GEN_DESC_CONTENT_LENGTH, HTTP_HEADER_VAL_UINT_NUMBER+msglen, HTTP_HEADER_CUSTOM_TEXT_END,
			HTTP_HEADER_GEN_END
	};
