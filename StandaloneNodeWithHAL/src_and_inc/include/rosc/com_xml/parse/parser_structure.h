...
typedef enum
{
	...
	PARSE_XML_QMTAG_START,
	PARSE_XML_EMTAG_START,
	PARSE_XML_TAG_ID,
	PARSE_XML_QMTAG,
...
typedef enum
{
	PARSE_XML_ATTRIBUTE_STATE_NONE,
	PARSE_XML_ATTRIBUTE_STATE_ID,
	PARSE_XML_ATTRIBUTE_STATE_EQUALS,
	PARSE_XML_ATTRIBUTE_STATE_START,
	PARSE_XML_ATTRIBUTE_STATE_INSIDE_SINGLE,
	PARSE_XML_ATTRIBUTE_STATE_INSIDE_DOUBLE,
}parse_xml_attribute_state_t;
